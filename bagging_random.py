#Bagging tree regressor optimized by Randomized Search
...
#Intitialize Randomized Search optimizer
random_search = RandomizedSearchCV(estimator=bagger, param_distributions=param_grid, cv=10, scoring='r2')
